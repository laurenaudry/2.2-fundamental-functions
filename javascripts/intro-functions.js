 ...
 */
/* found solution here. http://rmion.com/javascript-functional-programming-free-beginner-exercises/
*/
function rovarspraket(text){
  var spraketedString = ""
  for (var i = 0; i < text.length; i++) {
    if (!isVowel(text[i]) && text[i] !== " ") {
      spraketedString += text[i] + "o" + text[i];
    }
    else {
      spraketedString += text[i];
    }
  }
  if (spraketedString === ""){
    return "0"
 ...
 */
// w3 resource was really
// helpful for this one
//http://www.w3resource.com/javascript-exercises/javascript-function-exercise-6.php
// also this one
